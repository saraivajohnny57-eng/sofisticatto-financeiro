...
module.exports=async function(req,res){
  ...
  try{
    ...
    const patch={status,status_api:desc,ultima_ocorrencia:ultima,ultima_ocorrencia_em:quando,consulta_api:dados,metodo_consulta:metodo,consultado_api_em:new Date().toISOString(),sincronizacao_erro:null,atualizado_em:new Date().toISOString(),atualizado_por:'api_ssw_tracking_v50'};
