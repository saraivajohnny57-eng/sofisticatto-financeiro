...
module.exports=async function(req,res){
 ...
 try{const {convite_id,ambiente='homologacao',cnpjDestinatario,cepDestino,vlrMercadoria,peso,volumes,modal='R',tipoFrete='1',altura_cm=10,largura_cm=10,comprimento_cm=10}=req.body||{}; const c=await credenciais(convite_id,ambiente);
