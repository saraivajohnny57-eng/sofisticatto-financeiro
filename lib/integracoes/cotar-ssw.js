...
async function buscarIntegracao(nome){
  ...
  try{
    ...
    const achou=(rows||[]).find(x=>{
      const n=nomeNorm(x.transportadora_nome);
...
module.exports=async function(req,res){
  ...
  try{
    ...
    // V87: algumas transportadoras SSW (ex.: TG/TGT) exigem estes parâmetros
    // mesmo sendo opcionais na documentação geral do sswCotacao.
