...
module.exports=async function(req,res){
  ...
  try{
    ...
    const estrategiaFob=tipoFrete==='FOB'?'fob-pagador-destinatario-remetente-preservado':'cif-pagador-remetente';
