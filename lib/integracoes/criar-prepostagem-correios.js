...
module.exports=async function handler(req,res){
  try{
    ...
    // V127: a tela oficial mantém a seção de serviços adicionais mesmo quando nenhum
    // adicional é selecionado. Enviamos a lista explicitamente vazia para NÃO e 095 para SIM.
    base.listaServicoAdicional=adicionaisSeguros;
    ...
    console.log('[CORREIOS AEREO V127]',{id,codigoObjeto,...diagnosticoAereo});
