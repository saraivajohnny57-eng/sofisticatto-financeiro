...
module.exports=async function handler(req,res){
  try{
    ...
    // V124 — transporte aéreo Correios:
    // 095 é EXCLUSIVO para Artigos Perigosos ANAC / objeto com restrição aérea.
    // Conforme a regra oficial dos Correios, o adicional 095 deve ser informado SOMENTE
    // quando o objeto tiver restrição para transporte aéreo. Para objeto liberado, o
    // campo listaServicoAdicional é OMITIDO por completo (não enviamos [] nem 095).
    ...
    // Só envie listaServicoAdicional quando existir adicional real. Em especial,
    // nunca envie uma lista vazia para a opção 'Pode ser transportado por avião'.
