...
module.exports=async function handler(req,res){
  try{
    ...
    // V123 — transporte aéreo Correios:
    // 095 é EXCLUSIVO para Artigos Perigosos ANAC / objeto com restrição aérea.
    // Quando o usuário marca "Pode ser transportado por avião", enviamos a lista
    // explicitamente vazia. Isso evita que o rótulo oficial herde/assuma a marca de
    // restrição aérea por ausência do campo em alguma variação da API PPN.
    ...
    const base={
      ...
      listaServicoAdicional:adicionaisSeguros,
