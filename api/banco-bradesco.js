      ...
      if(http2xx){
        ...
        try{
          ...
          if(Array.isArray(existentes)&&existentes.length){
            ...
            await supabaseRest('cobrancas_bancarias',{method:'PATCH',query:`?id=eq.${encodeURIComponent(existenteId)}`,body:{status:'aberto',banco:'bradesco',banco_nome:'BRADESCO',origem:'emissao_bradesco_v258',nosso_numero:hist.nosso_numero,linha_digitavel:hist.linha_digitavel,codigo_barras:hist.codigo_barras,pdf_url:hist.pdf_url,emitido_em:agora,atualizado_em:agora}});
